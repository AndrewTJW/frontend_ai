    ...
    <section className="h-screen flex justify-center">
      <div className="mt-4 md:mt-6 lg:mt-8 w-full max-w-md px-4">
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="text-black border border-black hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-6 py-2.5 text-center font-formula-regular"
          >
